...
- NVIDIA GPU from our [supported hardware list](https://docs.inference.supply/hardware)
...
1. Check out the list of officially supported hardware [here](https://docs.inference.supply/hardware).
