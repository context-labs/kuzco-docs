...
Kuzco can also be run on Windows Subsystem for Linux (WSL). Checkout out our [WSL guide](/wsl) to get started.
...
1. Checkout the official guide to running Kuzco in Docker [here](https://docs.kuzco.xyz/docker).
2. Check out the list of officially supported hardware [here](https://docs.kuzco.xyz/hardware).
3. Join the [Kuzco Discord](https://discord.gg/kuzco) for more information and support.
