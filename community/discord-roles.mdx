...
### 1. Check Your Points
Log in to [the Inference.net dashboard](https://testnet.inference.net/dashboard) to see how many points you currently have. If you haven't reached the required amount for a role, keep on earning points until you do!

### 2. Link Your Discord Account
1. Go to your [dashboard settings](https://testnet.inference.net/dashboard/settings).  
