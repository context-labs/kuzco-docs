...
| **Late June 2025** | **Advanced Features** | • Full reputation scoring activation<br/>• Performance-based routing adjustments<br/>• Slashing mechanism testing (devnet only)<br/>• Additional operator pool management features                                              |
