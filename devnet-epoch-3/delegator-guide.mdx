...
- Alice was the first delegator to a new operator pool
- She staked 1,000 tokens and received 1,000 shares (1:1 ratio)
- The pool operates successfully and earns 100 token rewards
- Pool now has: 1,100 tokens, 1,000 shares (1.1:1 ratio)

**Sam decides to join:**

- Sam stakes 100 tokens to the same pool
- Sam's shares = (100 / 1,100) × 1,000 = 90.90... = 90 shares (rounded down)
- Pool now has: 1,200 tokens, 1,090 shares

**If Sam immediately unstakes all his shares:**

- Sam's tokens = (90 / 1,090) × 1,200 = 99.08... = 99 tokens (rounded down)
- The 1 token difference remains in the pool, benefiting Alice and future delegators
